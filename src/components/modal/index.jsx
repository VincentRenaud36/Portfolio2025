  ...
  return (
    <>
        <motion.div ref={modalContainer} variants={scaleAnimation} initial="initial" animate={active ? "enter" : "closed"} className={styles.modalContainer}>
            ...
            {
                data && data.projets && data.projets.map( (projet, index) => {
                const { src, colorProjet } = projet
                return <div className={styles.modal} style={{backgroundColor: colorProjet}} key={`modal_${index}`}>
                    <Image 
